...
# NB: il server MCP NON è più montato qui. Gira come servizio standalone
# dedicato (app/mcp/standalone.py, container "geko-mcp") per compatibilità
# col client MCP di Claude — vedi docs/superpowers/specs.
